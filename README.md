...
Semaphore, Jenkins, Docker Cloud, Bitrise, surf-build, Codeship, Drone, Buildkite, Nevercode, buddybuild, Visual Studio
Team Services, TeamCity, Screwdriver or Concourse.
